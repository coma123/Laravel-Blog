            ...
            <div class="info">
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="heading text-center">
                        ...
                        <p class="heading-text">{{ $settings->description }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="contacts">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="https://www.google.es/maps/place/Santander,+Cantabria/@43.4613391,-3.8461565,13z/data=!3m1!4b1!4m5!3m4!1s0xd4949ae8a6bee71:0xd27cdc801682ba96!8m2!3d43.4623057!4d-3.8099803" target="_blank" class="title">{{ $settings->address }}</a>
                        </div>
                    </div>
                </div>
            </div>
